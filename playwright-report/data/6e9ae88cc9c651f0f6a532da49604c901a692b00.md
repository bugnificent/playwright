...
Error: expect(page).toHaveScreenshot(expected)
  ...
  Expected an image 1280px by 9571px, received 1280px by 9643px. 740996 pixels (ratio 0.07 of all image pixels) are different.

Expected: C:\Users\Velespit\Playwright Project\visual-accessibility.spec.ts-snapshots\Visual-and-Accessibility-Tests-smoke---Visual-Regression-1-webkit-win32.png
Received: C:\Users\Velespit\Playwright Project\test-results\visual-accessibility-Visua-ec906-s-smoke---Visual-Regression-webkit-retry1\Visual-and-Accessibility-Tests-smoke---Visual-Regression-1-actual.png
    Diff: C:\Users\Velespit\Playwright Project\test-results\visual-accessibility-Visua-ec906-s-smoke---Visual-Regression-webkit-retry1\Visual-and-Accessibility-Tests-smoke---Visual-Regression-1-diff.png
...
Call log:
  ...
  - fonts loaded
  - Expected an image 1280px by 9571px, received 1280px by 9643px. 741523 pixels (ratio 0.07 of all image pixels) are different.

...
Error: expect(page).toHaveScreenshot(expected)
  ...
  Expected an image 390px by 17745px, received 1280px by 9643px. 1076320 pixels (ratio 0.05 of all image pixels) are different.

Expected: C:\Users\Velespit\Playwright Project\visual-accessibility.spec.ts-snapshots\Visual-and-Accessibility-Tests-smoke---Visual-Regression-1-Mobile-Safari-win32.png
Received: C:\Users\Velespit\Playwright Project\test-results\visual-accessibility-Visua-ec906-s-smoke---Visual-Regression-Mobile-Safari-retry1\Visual-and-Accessibility-Tests-smoke---Visual-Regression-1-actual.png
    Diff: C:\Users\Velespit\Playwright Project\test-results\visual-accessibility-Visua-ec906-s-smoke---Visual-Regression-Mobile-Safari-retry1\Visual-and-Accessibility-Tests-smoke---Visual-Regression-1-diff.png
...
Call log:
  ...
  - fonts loaded
  - Expected an image 390px by 17745px, received 1280px by 9643px. 1076761 pixels (ratio 0.05 of all image pixels) are different.

...
${(0, import_utils.stringifyStackFrames)(step.boxedStack).join("\n")}`;
  ...
  _resolveSnapshotPath(kind, pathSegments, sanitizeFilePath) {
    let subPath = import_path.default.join(...pathSegments);
    let ext = import_path.default.extname(subPath);
    ...
    if (sanitizeFilePath)
      subPath = (0, import_util.sanitizeFilePathBeforeExtension)(subPath, ext);

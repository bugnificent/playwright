...
Error: expect(page).toHaveScreenshot(expected)
  ...
  Expected an image 1280px by 9592px, received 1280px by 9663px. 784110 pixels (ratio 0.07 of all image pixels) are different.
...
Received: C:\Users\Velespit\Playwright Project\test-results\visual-accessibility-Visua-ec906-s-smoke---Visual-Regression-firefox-retry2\Visual-and-Accessibility-Tests-smoke---Visual-Regression-1-actual.png
    Diff: C:\Users\Velespit\Playwright Project\test-results\visual-accessibility-Visua-ec906-s-smoke---Visual-Regression-firefox-retry2\Visual-and-Accessibility-Tests-smoke---Visual-Regression-1-diff.png

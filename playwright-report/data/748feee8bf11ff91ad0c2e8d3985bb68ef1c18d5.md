...
Error: expect(page).toHaveScreenshot(expected)
  ...
  Expected an image 393px by 17773px, received 1280px by 9657px. 1078475 pixels (ratio 0.05 of all image pixels) are different.
...
Received: C:\Users\Velespit\Playwright Project\test-results\visual-accessibility-Visua-ec906-s-smoke---Visual-Regression-Mobile-Chrome\Visual-and-Accessibility-Tests-smoke---Visual-Regression-1-actual.png
    Diff: C:\Users\Velespit\Playwright Project\test-results\visual-accessibility-Visua-ec906-s-smoke---Visual-Regression-Mobile-Chrome\Visual-and-Accessibility-Tests-smoke---Visual-Regression-1-diff.png

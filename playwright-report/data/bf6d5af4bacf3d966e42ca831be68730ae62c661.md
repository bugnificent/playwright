...
Error: expect(page).toHaveScreenshot(expected)
  ...
  Expected an image 1280px by 9586px, received 1280px by 9657px. 766587 pixels (ratio 0.07 of all image pixels) are different.

Expected: C:\Users\Velespit\Playwright Project\visual-accessibility.spec.ts-snapshots\Visual-and-Accessibility-Tests-smoke---Visual-Regression-1-Google-Chrome-win32.png
Received: C:\Users\Velespit\Playwright Project\test-results\visual-accessibility-Visua-ec906-s-smoke---Visual-Regression-Google-Chrome-retry2\Visual-and-Accessibility-Tests-smoke---Visual-Regression-1-actual.png
    Diff: C:\Users\Velespit\Playwright Project\test-results\visual-accessibility-Visua-ec906-s-smoke---Visual-Regression-Google-Chrome-retry2\Visual-and-Accessibility-Tests-smoke---Visual-Regression-1-diff.png
...
Call log:
  ...
  - fonts loaded
  - Expected an image 1280px by 9586px, received 1280px by 9657px. 669734 pixels (ratio 0.06 of all image pixels) are different.

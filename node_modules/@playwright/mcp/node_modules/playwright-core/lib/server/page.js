...
__export(page_exports, {
  ...
  Worker: () => Worker,
  kUtilityInitScript: () => kUtilityInitScript
});
...
class Page extends import_instrumentation.SdkObject {
  constructor(delegate, browserContext) {
    ...
    this.timeoutSettings = new import_timeoutSettings.TimeoutSettings(browserContext._timeoutSettings);
...
class PageBinding {
  constructor(name, playwrightFunction, needsHandle) {
    ...
    this.initScript = new InitScript(
      `${js.accessUtilityScript()}.addBinding(${JSON.stringify(name)}, ${needsHandle})`,
      true
      /* internal */
    );
  ...
  static async dispatch(page, payload, context) {
    ...
    try {
      ...
      utilityScript.evaluate((utility, arg) => utility.deliverBindingResult(arg), { name, seq, result }).catch((e) => import_debugLogger.debugLogger.log("error", e));
    } catch (error) {
      utilityScript?.evaluate((utility, arg) => utility.deliverBindingResult(arg), { name, seq, error }).catch((e) => import_debugLogger.debugLogger.log("error", e));
    }
  }
}
class InitScript {
...
const kUtilityInitScript = new InitScript(
  `
  (() => {
    const module = {};

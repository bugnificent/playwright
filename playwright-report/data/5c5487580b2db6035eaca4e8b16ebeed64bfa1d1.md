...
Error: expect(page).toHaveScreenshot(expected)
  ...
  Expected an image 1280px by 9586px, received 1280px by 9657px. 766627 pixels (ratio 0.07 of all image pixels) are different.
...
Received: C:\Users\Velespit\Playwright Project\test-results\visual-accessibility-Visua-ec906-s-smoke---Visual-Regression-Google-Chrome-retry1\Visual-and-Accessibility-Tests-smoke---Visual-Regression-1-actual.png
    Diff: C:\Users\Velespit\Playwright Project\test-results\visual-accessibility-Visua-ec906-s-smoke---Visual-Regression-Google-Chrome-retry1\Visual-and-Accessibility-Tests-smoke---Visual-Regression-1-diff.png
...
Call log:
  ...
  - fonts loaded
  - Expected an image 1280px by 9586px, received 1280px by 9657px. 669774 pixels (ratio 0.06 of all image pixels) are different.

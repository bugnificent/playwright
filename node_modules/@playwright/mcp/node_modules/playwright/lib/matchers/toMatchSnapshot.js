...
class SnapshotHelper {
  constructor(testInfo, matcherName, locator, anonymousSnapshotExtension, configOptions, nameOrOptions, optOptions) {
    ...
    if (!name) {
      ...
      expectedPathSegments = [(0, import_util.trimLongString)(fullTitleWithoutSpec) + "." + anonymousSnapshotExtension];
      ...
      if (Array.isArray(name)) {
        ...
        joinedName = name.join(import_path.default.sep);
      } else {
        expectedPathSegments = [name];
        joinedName = (0, import_util.sanitizeFilePathBeforeExtension)((0, import_util.trimLongString)(name, import_util.windowsFilesystemFriendlyLength));
      }
